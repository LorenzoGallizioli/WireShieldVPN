...
/**
 * Unit tests for the Connection class in the WireGuard module.
 * This class tests various methods of the Connection class including traffic retrieval,
 * status management, interface detection, and more.
 */
...
public class ConnectionTest {
    ...
    /**
     * Test the behavior of the getTraffic() method when valid traffic data is returned.
     * This test mocks the output of the 'wgShow' command.
     */
    @Test
    ...
    /**
     * Test setting and getting the connection status.
     * This method tests the setter and getter of the connection status field.
     */
    @Test
    ...
    /**
     * Test the getActiveInterface() method.
     * This test simulates the output of the command to get the active interface.
     */
    @Test
    ...
    /**
     * Test the getLastHandshakeTime() method.
     * This test simulates the output of the command to retrieve the last handshake time.
     */
    @Test
    ...
    /**
     * Test the toString() method of the Connection class.
     * This test ensures that the string representation of the Connection object is as expected.
     */
    @Test
