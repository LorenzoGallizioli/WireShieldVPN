...
public class DownloadManagerTest {
	 ...
	 * DownloadManager and AntivirusManager, and creates a temporary directory for
	 * testing.
	 * 
	...
	public void testStartAndStopMonitoring() throws IOException, InterruptedException {
		...
		assertNotSame("Monitoring should be stopped", downloadManager.getMonitorStatus() == runningStates.UP);
