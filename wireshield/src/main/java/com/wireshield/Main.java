...
public class Main {
    /**
     * The main method to launch the WireShield application.
     * It verifies if the application has administrative rights before proceeding.
     * If the application is not running as an administrator, it displays an
     * informational message and terminates the execution.
     *
     ...
     * It attempts to execute the "net session" command, which requires admin rights.
     *
