...
public class ScanReport {
	...
	public Boolean isThreatDetected() {
		return warningClass == warningClass.DANGEROUS || warningClass == warningClass.SUSPICIOUS;
	}
	 ...
	 * 
	 * @return String The string representation of the scan report.
	 */
	@Override
	public String toString() {
		return "ScanReport {" + "file=" + (file != null ? file.getName() : "null") + ", threatDetected="
				+ threatDetected + ", threatDetails='" + threatDetails + '\'' + ", warningClass=" + warningClass
				+ ", isValid=" + isValid + '}';
	}
}
